...
<body>
	...
	<main>
		<section class="user-content">
			...
			?>
				<div>
					<button id="btnExcluir" onclick="window.location.href='confirmaExcluirCliente.php?id=<?php echo $row['codigo']; ?>'">
						Excluir
					</button>
					<button id="btnVoltar" onclick="window.location.href='../../DataConsult/Cliente/consultaCliente.php'">Voltar</button>
				</div>
			<?php
			}
			?>
