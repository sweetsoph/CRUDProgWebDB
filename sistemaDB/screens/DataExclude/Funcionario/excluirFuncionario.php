	...
	<main>
		<section class="user-content">
			...
			while ($row = $select->fetch()) {
				...
				echo "<br><b>Dt. Admissão: </b>" . $row['dtAdmissao'];
				echo "<br><b>Salário: </b>" . $row['vlSalario'];
			...
			?>
				<div>
					<button id="btnExcluir" onclick="window.location.href='confirmaExcluirFuncionario.php?id=<?php echo $row['codigo']; ?>'">
						Excluir
					</button>
					<button id="btnVoltar" onclick="window.location.href='../../DataConsult/Funcionario/consultaFuncionario.php'">Voltar</button>
				</div>
			<?php
			}
			?>
