	...
	<main>
		<section class="user-content">
			...
			while ($row = $select->fetch()) {
				...
				echo "<br><b>Preço: </b>" . $row['vlPreco'];
				echo "<br><b>Quantidade em Estoque: </b>" . $row['qtEstoque'];
				echo "</p>";
			?>
				<div>
					<button id="btnExcluir" onclick="window.location.href='confirmaExcluirProduto.php?id=<?php echo $row['codigo']; ?>'">
						Excluir
					</button>
					<button id="btnVoltar" onclick="window.location.href='../../DataConsult/Produto/consultaProduto.php'">Voltar</button>
				</div>
			<?php
			}
			?>
